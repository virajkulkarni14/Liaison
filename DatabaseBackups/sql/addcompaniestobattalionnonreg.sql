...
VALUES 
(0, null, 'Headquarters & Service','___'+@batnumb+ @batord+' ' +@battext+ ' Bn., RM', 4,3,'|', @admincorpsid, 1, null)
, (0, @unitA, null, '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
, (0, @unitB, null, '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
, (0, @unitC, null, '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
, (0, @unitD, null, '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
, (0, @unitE, null, '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
--, (0, @unitF, null, '___'+@batnumb+ @batord+ +@battext+' Bn., RM',4,3,'|', @admincorpsid, 1, null)
, (0, null, 'Engineer Support', '___'+@batnumb+ @batord+ ' ' +@battext+ ' Bn., RM',4,3,'|', @admincorpsid, 1, null)
...
set @wpn_id=(SELECT ID FROM ( SELECT ROW_NUMBER () OVER (ORDER BY id) AS RowNum, * FROM @OutputTbl ) sub WHERE RowNum = 7)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-HSC',@hsc_id, 0, 1, 1, 0, 50)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitA,@a_id, 0, 1, 1, 0, 50)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitB,@b_id, 0, 1, 1, 0, 50)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitC,@c_id, 0, 1, 1, 0, 50)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitD,@d_id, 0, 1, 1, 0, 50)
...
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitE,@e_id, 0, 1, 1, 0, 50)

--, ('RM@' +@batcode+ '___'+@batnumb+'|'+@unitF,@f_id, 1, 1, 0, 0, 10),
--(@unitF+'-___'+@batnumb+' ' +@batcode+ 'B/RM',@f_id, 0, 1, 0, 0, 20),
--(@unitF+' Coy., ___'+@batnumb+@batord+' ' +@battext+ ' Bn., RM',@f_id, 0, 1, 0, 0, 30),
--('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-'+@unitF,@f_id, 0, 1, 1, 0, 50)

, ('RM@' +@batcode+ '___'+@batnumb+'|ES', @wpn_id, 1, 1, 0, 0, 10)
, ('ESC-___'+@batnumb+' ' +@batcode+ 'B/RM',@wpn_id, 0, 1, 0, 0, 20)
, ('Eng. Supt. Coy., ___'+@batnumb+@batord+' ' +@battext+ ' Bn., RM',@wpn_id, 0, 1, 0, 0, 30)
, ('~USMC MARINES ' +@batcode+ ' ___'+@batnumb+'-ESC',@wpn_id, 0, 1, 1, 0, 50)
...
-- @wpn_id,@f_id
select indexcode from unitindex where unitid in (@hsc_id, @a_id, @b_id, @c_id,@d_id,@e_id, @wpn_id) order by UnitId, DisplayOrder
